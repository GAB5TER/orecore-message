...
const { Address } = orecore;
const { Signature } = orecore.crypto;

describe('Message', () => {
  const address = 'yZKdLYCvDXa2kyQr8Tg3N6c3xeZoK7XDcj';
  const badAddress = 'yj3v6A6gQkiRbChbGwvahiFZ6EfpYxk9na';
  const privateKey = orecore.PrivateKey.fromWIF('cR4qogdN9UxLZJXCNFNwDRRZNeLRWuds9TTSuLNweFVjiaE4gPaq');
  ...
  it('will verify with an uncompressed pubkey', () => {
    const otherPrivateKey = new orecore.PrivateKey('67fd2209ce4a95f6f1d421ab3fbea47ada13df11b73b30c4d9a9f78cc80651ac');
